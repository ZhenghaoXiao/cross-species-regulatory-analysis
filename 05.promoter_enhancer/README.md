...
These files come from Task 2 (Xingyu's cross-species mapping in `03.mapping/`):
...
1. Copy the input files from `03.mapping/` into your working directory.
